          ...
          {menus.map((menu) => (
            <div key={menu.id} className={`menu-card ${menu.is_active ? 'menu-card--active' : ''}`}>
              ...
              <div className="menu-card-actions">
                <a
                  href={`/share/${menu.share_token}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn btn-secondary btn-sm menu-card-view"
                  title="Open the guest menu in a new tab"
                  aria-label={`Open the guest menu for ${menu.name} in a new tab`}
                >
