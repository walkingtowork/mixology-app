...
export function UmeDecoration() {
  return (
    <svg
      ...
      style={{ position: 'absolute', bottom: 0, left: 0, pointerEvents: 'none', zIndex: 0, opacity: 0.5, transform: 'scale(-1, -1)' }}
      aria-hidden="true"
    >
...
export function TacoDecoration() {
  return (
    <svg
      ...
      style={{ position: 'absolute', top: 0, right: 0, pointerEvents: 'none', zIndex: 0, opacity: 0.5, transform: 'scale(-1, -1)' }}
      aria-hidden="true"
    >
